...
# Set up input and output directories specific to the KAKU4 dataset
FASTQ_DIR=/global/scratch/users/enricocalvane/heejae_as/kaku_data
OUTPUT_DIR=/global/scratch/users/enricocalvane/heejae_as/kaku_data/aligned_bams
...
for READ1 in ${FASTQ_DIR}/*_read1.fastq.gz
do
    # Extract the base sample name by removing the '_read1.fastq.gz' suffix
    # This will give us names like 'SRR27228275_kaku4_3' or 'SRR27228278_col_3'
    BASE_SAMPLE=$(basename $READ1 _read1.fastq.gz)
    
    # Construct the path to the matching read2 file
    READ2=${FASTQ_DIR}/${BASE_SAMPLE}_read2.fastq.gz
