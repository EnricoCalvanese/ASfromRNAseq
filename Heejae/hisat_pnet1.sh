...
# Set up input and output directories specific to the pnet1 dataset
FASTQ_DIR=/global/scratch/users/enricocalvane/heejae_as/pnet1_data
OUTPUT_DIR=/global/scratch/users/enricocalvane/heejae_as/pnet1_data/aligned_bams
...
do
    ...
    # This will give us names like 'Col-0-1_FRRB192015921-1a'
