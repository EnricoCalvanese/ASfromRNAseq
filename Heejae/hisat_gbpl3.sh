...
FASTQ_DIR=/global/scratch/users/enricocalvane/heejae_as/gbpl3_data
OUTPUT_DIR=/global/scratch/users/enricocalvane/heejae_as/gbpl3_data/aligned_bams
mkdir -p $OUTPUT_DIR
...
do
    # Get the base sample name by removing '_read1.fastq.gz'
